...
[ADR 0023](0023-host-plane-settings-row.md) amends the last sentence: the patch now carries one Host-plane row that owns the settings namespace and the Web card. The delegation surface this ADR describes is unchanged and still agent-plane.
